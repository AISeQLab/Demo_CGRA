...
void assign_S_xor_R(){
	...
	OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
...
void round_ne(uint64_t t){
	...
	for (int i = 1; i < 8; i++){
	 if (i == 1) { //THETA STEP
		...
		*/
			...
			exe64(OP, x, PE_out[7],/*ALU in*/ PE_out[3][4],PE_out[3][5],PE_out[3][6],PE_out[3][7], /*BUFF 16to1 in*/ PE_out[3][4],PE_out[3][5],PE_out[3][6],PE_out[3][7], /*BUFF 8to1 in*/ PE_out[3][8],PE_out[3][9],PE_out[3][10],PE_out[3][4]);
		...
		*/
			...
			exe64(OP, x, PE_out[8],/*ALU in*/ PE_out[5][2],0,0,PE_out[4][2], /*BUFF 16to1 in*/ PE_out[4][4],PE_out[4][5],PE_out[4][6],PE_out[4][7], /*BUFF 8to1 in*/ PE_out[4][8],PE_out[4][9],PE_out[4][10],PE_out[4][11]); //	X	D[1]	X	X
			exe64(OP, x, PE_out[9],/*ALU in*/ PE_out[4][1],0,0,PE_out[5][1], /*BUFF 16to1 in*/ PE_out[5][4],PE_out[5][5],PE_out[5][6],PE_out[5][7], /*BUFF 8to1 in*/ PE_out[5][8],PE_out[5][9],PE_out[5][10],PE_out[5][11]); // X		D[2]	X	X
			exe64(OP, x, PE_out[10],/*ALU in*/PE_out[5][1],0,0,PE_out[5][2], /*BUFF 16to1 in*/ PE_out[6][4],PE_out[6][5],PE_out[6][6],PE_out[6][7], /*BUFF 8to1 in*/ PE_out[6][8],PE_out[6][9],PE_out[6][10],PE_out[6][11]); //X	D[4]	X	X
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_ROL,/*SRU2_IM*/1,/*LU3*/OP_XOR);
			exe64(OP, x, PE_out[11],/*ALU in*/ PE_out[6][1],0,PE_out[5][6],PE_out[4][1], /*BUFF 16to1 in*/ PE_out[4][1],PE_out[4][2],PE_out[7][6],PE_out[7][7], /*BUFF 8to1 in*/ PE_out[7][8],PE_out[7][9],PE_out[7][10],PE_out[7][11]); // X		D[0]	C[4]	X   // c[1] AND C[2] SAVE IN BUFFER 16 [4] [5]
		
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_ROL,/*SRU2_IM*/1,/*LU3*/OP_XOR);
			exe64(OP, x, PE_out[12],/*ALU in*/ PE_out[11][5],0,0,PE_out[11][2], /*BUFF 16to1 in*/ PE_out[8][4],PE_out[8][5],PE_out[8][6],PE_out[8][7], /*BUFF 8to1 in*/ PE_out[8][8],PE_out[8][9],PE_out[8][10],PE_out[8][11]); // X		D[3]	X		X
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
			...
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[15],/*ALU in*/ PE_out[9][1], 0, 0,PE_out[10][1], /*BUFF 16to1 in*/ PE_out[11][1],PE_out[8][1],PE_out[11][6],PE_out[11][7], /*BUFF 8to1 in*/ PE_out[11][8],PE_out[11][9],PE_out[11][10],PE_out[11][11]);  //	X	D[4]	D[2]	X	// SAVE D[0] IN [4] AND D[1] IN [5]
                                                                                                                                    //D[0]                 D[1]
}
	...
	//-> DONE THETA STEP
		...
		*/
		...
		//mop64(OP_LDW, 0, 0, LMM[0], PE_out[1],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);  // 
			...
			exe64(OP, x, PE_out[0],/*ALU in*/ PE_out[12][4],0,0,PE_out[12][5], /*BUFF 16to1 in*/ PE_out[12][4],PE_out[12][5],PE_out[12][6],PE_out[12][7], /*BUFF 8to1 in*/ PE_out[12][8],PE_out[12][9],PE_out[12][10],PE_out[12][11]); //	X	B[3][4]		B[2][1]		X
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/45,/*SRU2*/OP_ROL,/*SRU2_IM*/2,/*LU3*/OP_NOP);	
			exe64(OP, x, PE_out[1],/*ALU in*/ PE_out[13][4],0,0,PE_out[13][5], /*BUFF 16to1 in*/ PE_out[13][4],PE_out[13][5],PE_out[13][2],PE_out[13][1], /*BUFF 8to1 in*/ PE_out[13][8],PE_out[13][9],PE_out[13][10],PE_out[13][11]); // 	x	B[4][4]		B[3][1]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/27,/*SRU2*/OP_ROL,/*SRU2_IM*/36,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[2],/*ALU in*/ PE_out[14][4],0,0,PE_out[14][5], /*BUFF 16to1 in*/ PE_out[14][4],PE_out[14][5],PE_out[14][6],PE_out[14][7], /*BUFF 8to1 in*/ PE_out[14][8],PE_out[14][9],PE_out[14][10],PE_out[14][11]); // 	x	B[1][3]		B[0][3]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/21,/*SRU2*/OP_ROL,/*SRU2_IM*/8,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[3],/*ALU in*/ PE_out[14][6],0,0,PE_out[14][7], /*BUFF 16to1 in*/ PE_out[15][4],PE_out[15][5],PE_out[15][6],PE_out[15][7], /*BUFF 8to1 in*/ PE_out[15][8],PE_out[15][9],PE_out[15][10],PE_out[15][11]);// 	x	B[3][2]		B[3][0]		x
		/*
		-> AFTER EACH ROUND OF SHA3, LAST ROW OF PES MUST BE RETURN AS THIS SAMPLE
		...
		*/	                                                                                                                                                                                                  
			...
			exe64(OP, x, PE_out[4],/*ALU in*/ PE_out[0][6],0,0,PE_out[0][7], /*BUFF 16to1 in*/ PE_out[0][2],PE_out[0][1],PE_out[0][6],PE_out[0][7], /*BUFF 8to1 in*/ PE_out[0][8],PE_out[0][9],PE_out[0][10],PE_out[0][11]); //	X	B[2][3]		B[4][2]		X
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/43,/*SRU2*/OP_ROL,/*SRU2_IM*/15,/*LU3*/OP_NOP);	
			exe64(OP, x, PE_out[5],/*ALU in*/ PE_out[1][6],0,0,PE_out[1][7], /*BUFF 16to1 in*/ PE_out[1][2],PE_out[1][1],PE_out[1][6],PE_out[1][7], /*BUFF 8to1 in*/ PE_out[1][8],PE_out[1][9],PE_out[1][10],PE_out[1][11]); // x		B[3][3]		B[2][0]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/61,/*SRU2*/OP_ROL,/*SRU2_IM*/25,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[6],/*ALU in*/ PE_out[2][8],0,0,PE_out[2][9], /*BUFF 16to1 in*/ PE_out[2][2],PE_out[2][1],PE_out[3][2],PE_out[3][1], /*BUFF 8to1 in*/ PE_out[2][8],PE_out[2][9],PE_out[2][10],PE_out[2][11]); // x		B[2][2]		B[4][1]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/39,/*SRU2*/OP_ROL,/*SRU2_IM*/56,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[7],/*ALU in*/ PE_out[2][10],0,0,PE_out[2][11], /*BUFF 16to1 in*/ PE_out[3][4],PE_out[3][5],PE_out[3][6],PE_out[3][7], /*BUFF 8to1 in*/ PE_out[3][8],PE_out[3][9],PE_out[3][10],PE_out[3][11]);// x		B[4][3]		B[2][4]		x
		...
		*/	
			...
			exe64(OP, x, PE_out[8],/*ALU in*/ PE_out[4][8],0,0,PE_out[4][9], /*BUFF 16to1 in*/ PE_out[4][4],PE_out[4][5],PE_out[4][1],PE_out[4][2], /*BUFF 8to1 in*/ PE_out[4][8],PE_out[4][9],PE_out[4][10],PE_out[4][11]); //	X	B[0][2]		B[0][0]		X
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/62,/*SRU2*/OP_ROL,/*SRU2_IM*/28,/*LU3*/OP_NOP);	
			exe64(OP, x, PE_out[9],/*ALU in*/ PE_out[5][8],0,0,PE_out[5][9], /*BUFF 16to1 in*/ PE_out[5][4],PE_out[5][5],PE_out[5][1],PE_out[5][2], /*BUFF 8to1 in*/ PE_out[5][8],PE_out[5][9],PE_out[5][10],PE_out[5][11]); // x		B[3][1]		B[0][4]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/14,/*SRU2*/OP_ROL,/*SRU2_IM*/20,/*LU3*/OP_NOP);
			exe64(OP, x, PE_out[10],/*ALU in*/ PE_out[5][10],0,0,PE_out[5][11], /*BUFF 16to1 in*/ PE_out[6][1],PE_out[6][2],PE_out[7][1],PE_out[7][2], /*BUFF 8to1 in*/ PE_out[6][4],PE_out[6][5],PE_out[6][6],PE_out[6][7]); // x		B[1][1]		B[4][0]		x
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/55,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
		...
		*/	
			...
			exe64(OP, x, PE_out[12],/*ALU in*/ PE_out[8][10],0,0,PE_out[8][11], /*BUFF 16to1 in*/ PE_out[8][1],PE_out[8][2],PE_out[8][10],PE_out[8][11], /*BUFF 8to1 in*/ PE_out[8][4],PE_out[8][5],PE_out[8][6],PE_out[8][7]); 
			OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
			...
			exe64(OP, x, PE_out[14],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ PE_out[10][4],PE_out[10][5],PE_out[10][6],PE_out[10][7], /*BUFF 8to1 in*/ PE_out[10][8],PE_out[10][9],PE_out[10][10],PE_out[10][11]); 
			exe64(OP, x, PE_out[15],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ PE_out[11][2],PE_out[11][2],PE_out[11][2],PE_out[11][2], /*BUFF 8to1 in*/ PE_out[11][8],PE_out[11][9],PE_out[11][10],PE_out[11][11]);
							/*
		-> AFTER EACH ROUND OF SHA3, LAST ROW OF PES MUST BE RETURN AS THIS SAMPLE
	...
	//	exe64(OP, x, PE_out[0],/*ALU in*/ B,~,0,0x0609, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ 0,0,0,0); 
		...
		*/
		...
		exe64(OP, x, PE_out[14],/*ALU in*/ PE_out[11][4],PE_out[10][7],0,PE_out[8][9], /*BUFF 16to1 in*/ PE_out[10][4],PE_out[10][5],PE_out[10][6],PE_out[10][7], /*BUFF 8to1 in*/ PE_out[10][8],PE_out[10][9],PE_out[10][10],PE_out[10][11]); //X		S[1][4]		X		X
	...
	//	exe64(OP, x, PE_out[0],/*ALU in*/ B,~,0,0x0609, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ 0,0,0,0); 
		...
		*/	
		...
		exe64(OP, x, PE_out[3],/*ALU in*/ PE_out[13][0],0,0,PE_out[13][1], /*BUFF 16to1 in*/ PE_out[15][4],PE_out[15][5],PE_out[15][6],PE_out[15][7], /*BUFF 8to1 in*/ PE_out[15][8],PE_out[15][9],PE_out[15][10],PE_out[15][11]); //X		S43		S33		X
		...
		PE[3] = X	x	X	X	S[3][1]		X			X			X			X			X			X			X
		*/
		mop64(OP_LDW, 0,PE_out[4],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/  PE_out[0][4],PE_out[0][5],PE_out[0][6],PE_out[0][7], /*BUFF 8to1 in*/ PE_out[0][8],PE_out[0][9],PE_out[0][10],PE_out[0][11]); //LMM[4] =  S12		S04
		mop64(OP_LDW, 0,PE_out[5],/*ALU in*/ 0,0,PE_out[0][0],PE_out[0][1], /*BUFF 16to1 in*/  PE_out[1][4],PE_out[1][5],PE_out[1][1],PE_out[1][0], /*BUFF 8to1 in*/ PE_out[1][8],PE_out[1][9],PE_out[1][10],PE_out[1][11]); //LMM[5] =  S03		S02    S23
		mop64(OP_LDW, 0,PE_out[6],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ PE_out[3][1],PE_out[3][2],PE_out[2][1],PE_out[2][7], /*BUFF 8to1 in*/ PE_out[2][4],PE_out[2][5],PE_out[2][5],PE_out[2][7]); //	LMM[6] = S41	S44
		mop64(OP_LDW, 0,PE_out[7],/*ALU in*/ 0,0,PE_out[2][0],0, /*BUFF 16to1 in*/ PE_out[3][4],PE_out[3][5],PE_out[3][6],PE_out[3][7], /*BUFF 8to1 in*/ PE_out[3][8],PE_out[3][9],PE_out[3][10],PE_out[3][11]); //LMM[7] = S[3][2]	S[2][4]		S31
...
void Get_Result(){
	...
	printf("A[%d][%d] = %16lx\n", 4, 4, PE_out[13][6]);
			/*
		-> AFTER EACH ROUND OF SHA3, LAST ROW OF PES MUST BE RETURN AS THIS SAMPLE
		PE[12] = X	X	X	X	S[0][0]		S[1][0]		S[1][1]		S[2][1]		S[0][2]		S[0][3]		S[0][4]		S[1][2]
		PE[13] = X 	X	X	X	S[2][0]		S[3][0]		S[4][4] 	S[4][1]		S[1][3]		S[1][4]		S[2][2]		S[2][3]
		PE[14] = X	X	X	X 	S[4][0]		S[0][1]		S[3][3]		S[3][4]		S[2][4]		S[3][2]		S[4][2]		S[4][3]
		PE[15] = X	X	X	X	S[3][1]		X			X			X			X			X			X			X
		-> 00 01 02 03 04 10 11 12
		*/ 
	U32 OP;
	U64 OP_Immidiate;
	U64 x = 0;
	mop64(OP_STW, 0, PE_out[0],/*ALU in*/ PE_out[12][4],PE_out[12][5],0,0, /*BUFF 16to1 in*/ PE_out[12][4],PE_out[12][5],PE_out[12][6],PE_out[12][7], /*BUFF 8to1 in*/ PE_out[12][8],PE_out[12][9],PE_out[12][10],PE_out[12][11]);  // 00		10
	mop64(OP_STW, 0, PE_out[1],/*ALU in*/ PE_out[13][4],PE_out[13][5],0,0, /*BUFF 16to1 in*/ PE_out[13][4],PE_out[13][5],PE_out[13][6],PE_out[13][7], /*BUFF 8to1 in*/ PE_out[13][8],PE_out[13][9],PE_out[13][10],PE_out[13][11]);	// 20		30
	mop64(OP_STW, 0, PE_out[2],/*ALU in*/ PE_out[14][4],PE_out[14][5],0,0, /*BUFF 16to1 in*/ PE_out[14][4],PE_out[14][5],PE_out[14][6],PE_out[14][7], /*BUFF 8to1 in*/ PE_out[14][8],PE_out[14][9],PE_out[14][10],PE_out[14][11]);  // 40		01
	mop64(OP_STW, 0, PE_out[3],/*ALU in*/ PE_out[12][6],PE_out[12][7],0,0, /*BUFF 16to1 in*/ PE_out[15][4],PE_out[15][5],PE_out[15][6],PE_out[15][7], /*BUFF 8to1 in*/ PE_out[15][8],PE_out[15][9],PE_out[15][10],PE_out[15][11]); // 11		21

	exe64(OP_NOP, 0, PE_out[4],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 00		10
	exe64(OP_NOP, 0, PE_out[5],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );	// 20		30
	exe64(OP_NOP, 0, PE_out[6],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 40		01
	exe64(OP_NOP, 0, PE_out[7],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 ); // 11		21

	exe64(OP_NOP, 0, PE_out[8],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 00		10
	exe64(OP_NOP, 0, PE_out[9],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );	// 20		30
	exe64(OP_NOP, 0, PE_out[10],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 40		01
	exe64(OP_NOP, 0, PE_out[11],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 ); // 11		21
	
	exe64(OP_NOP, 0, PE_out[12],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 00		10
	exe64(OP_NOP, 0, PE_out[13],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );	// 20		30
	exe64(OP_NOP, 0, PE_out[14],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 );  // 40		01
	exe64(OP_NOP, 0, PE_out[15],/*ALU in*/ 0, 0, 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0 ); // 11		21
	
	printf("Hash value: ");
	printf("%16lx ", LMM[0][0][0]);
	printf("%16lx ", LMM[0][1][0]);
	printf("%16lx ", LMM[1][0][0]);
	printf("%16lx ", LMM[1][1][0]);
	printf("%16lx ", LMM[2][0][0]);
	printf("%16lx ", LMM[2][1][0]);
	printf("%16lx ", LMM[3][0][0]);
	printf("%16lx\n", LMM[3][1][0]);
...
int main(){
	...
	//LMM[3][1][0] = EndianSwap(LMM[3][1][0]);
	//LMM[7][0][0] = EndianSwap(LMM[7][0][0]);
	...
	*(CGRA_info.ctx_pe_mmap+START_BASE_IP) = 1;
	...
	dma_read_U64(ROW1_LSB_BASE_PHYS,8);
